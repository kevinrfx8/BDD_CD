                        ...
                        <form class="col s12" id="filtros">
                            <div class="row">
                                ...
                                <div class="input-field col-md-2">
                                    ...
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal" ng-click="limpiar()">Nueva Agencia</button>
                                </div>
                            </div>
                            <div class=" row ">
                ...
                controller.service.update({
                    ...
                    , function (response) {
                        $.toaster({
                            priority: 'danger'
                            , title: 'Error'
                            , message: 'No se pudo modificar la agencia'
                        });
                    });
            ...
            $scope.insertar = function () {
                ...
                controller.service.save($scope.nuevo).$promise.then(function (response) {
                    ...
                    $.toaster({
                        priority: 'danger'
                        , title: 'Error'
                        , message: 'No se pudo agregar la agencia'
                    });
                });
            };
            /*-----------------------------Limpiar-----------------------------------*/
